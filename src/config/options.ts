...
export const WORKING_SWEEP_MODE_VALUES: ReadonlyArray<WorkingSweepMode> = ["top", "perimeter"];
...
/** Advance to the next option; wrap or start at the first when the value is unknown. */
