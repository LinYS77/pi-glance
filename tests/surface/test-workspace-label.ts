...
import { formatWorkspaceLabel, stripControls } from "../../src/surface/format.js";
...
assert.ok(stripControls(renderedTop(56)).includes("Sonnet 4"), "Model survives before other facts when the seam budget is tight");
