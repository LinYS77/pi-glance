...
import { showGlancePane, type GlancePaneOptions } from "../src/settings/pane.js";
...
assertContains(
	...
	"spd 42 tok/s",
	"Model speed preview should render real previewState.throughput.lastRun as final without ~",
);
